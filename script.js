...
function drawClockFaces() {
    ...
    clockFaces.forEach(clockFace => {
        ...
        const currentIndex = valueSet.findIndex(
            v => String(v) === String(currentValue)
        );
